        ...
        <section class="dashboard-actions">
            ...
            <div class="actions-grid">
                <div class="action-card">
                    <i class="fas fa-history"></i>
                    <h3>Xe điện mini</h3>
                    <p><strong>Ngày thuê:</strong> 01/04/2025</p>
                    <p><strong>Trạm:</strong> A → B</p>
                    <p><strong>Thời gian:</strong> 1 giờ 20 phút</p>
                </div>
                <div class="action-card">
                    <i class="fas fa-history"></i>
                    <h3>Xe điện thể thao</h3>
                    <p><strong>Ngày thuê:</strong> 22/03/2025</p>
                    <p><strong>Trạm:</strong> B → C</p>
